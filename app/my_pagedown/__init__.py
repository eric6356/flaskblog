...
class _pagedown(object):
    def include_pagedown(self):
        return Markup('''
<script type="text/javascript" src="/static/pagedown/Markdown.Converter.min.js"></script>
<script type="text/javascript" src="/static/pagedown/Markdown.Sanitizer.min.js"></script>
''')
